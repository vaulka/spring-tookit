...
public class CustomMinioClient extends MinioClient {
    ...
    /**
     * 将 {@link S3Base#createMultipartUpload(String, String, String, Multimap, Multimap)} 修饰符改为 public
     *
    ...
    /**
     * 将 {@link S3Base#uploadPart(String, String, String, Object, int, String, int, Multimap, Multimap)} 修饰符改为 public
     *
     * @param bucketName       Name of the bucket.
    ...
    /**
     * 将 {@link S3Base#listParts(String, String, String, Integer, Integer, String, Multimap, Multimap)} 修饰符改为 public
     *
     * @param bucketName       Name of the bucket.
    ...
    /**
     * 将 {@link S3Base#completeMultipartUpload(String, String, String, String, Part[], Multimap, Multimap)} 修饰符改为 public
     *
     * @param bucketName       Name of the bucket.
